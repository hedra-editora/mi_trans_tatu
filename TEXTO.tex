...
\begin{figure}
\vspace*{-.5cm}
\hspace*{-2.3cm}\includegraphics[width=140mm]{./imgs/img1.pdf}
\end{figure}
...
\begin{figure}
\vspace*{-.5cm}
\hspace*{-2.2cm}\includegraphics[width=138mm]{./imgs/img2.pdf}
\end{figure}
...
--- Ô, velha, você só fica
comendo o nosso milho-verde.\break
Ela respondia:\break
--- Como só milho-verde, por
não poder comer milho seco.
...
\begin{figure}
\vspace*{-.9cm}
\hspace*{-2.5cm}\includegraphics[width=143mm]{./imgs/img3.pdf}
\end{figure}
...
\letra{A}{velha} só comia milho-verde 
por não poder comer
milho seco, que é duro.
Quando acabou o milho-verde
do roçado deles, os homens
...
\begin{figure}
\vspace*{-1.3cm}
\hspace*{-2.5cm}\includegraphics[width=145mm]{./imgs/img5.pdf}
\end{figure}
...
\begin{figure}
\vspace*{-2.5cm}
\hspace*{-2.8cm}\includegraphics[width=152mm]{./imgs/img6.pdf}
\end{figure}
...
Só posso 
comer milho-verde. 
Mas como esculhambaram comigo, vim cavar um
...
\begin{figure}
\vspace*{-2cm}
\hspace*{-2.8cm}\includegraphics[width=150mm]{./imgs/img8.pdf}
\end{figure}
...
\letra{O}{caçador} disse ao filho
da velha, que estava chorando:\break
--- A velha que vocês esculhambaram
já virou tatu. Ela~já tem rabo, casco
nas costas, casco na cabeça. Virou
todinha tatu. A velha sente falta
...
\begin{figure}
\vspace*{-1cm}
\hspace*{-2.2cm}\includegraphics[width=138mm]{./imgs/img10.pdf}
\end{figure}
...
--- O meu filho está chorando, vou vê-lo.\break
Voltou à aldeia para vê-lo; lá estava ele
sentado, chorando. Quando viu o tatu,
...
\begin{figure}
\vspace*{-2cm}
\hspace*{-2.8cm}\includegraphics[width=150mm]{./imgs/img12.pdf}
\end{figure}
...
domesticou a batata-doce para
podermos comer foi o tatu,
e~quando não tinha batata-doce
para comer, o tatu comia minhoca.
Foi assim que a velha fez para
virar tatu, transformou o corpo e~passou a comer batata-doce e,
quando não tinha, comia minhoca.
